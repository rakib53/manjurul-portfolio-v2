...
export default function MyStoryWorkExperience() {
  return (
    <section className="max-w-[1440px] mx-auto relative" id="work_experience">
      <Image
        src={star}
        alt="star"
            ...
            <div>
              ...
              <div className="text-[#344054] text-xl leading-[31px] tracking-[-0.6px]">
                <span>
                  ...
                  solutions to streamline the exam-taking process for university
                  students. In my role as a UI/UX Designer, I have successfully
                ...
                <ul>
                  ...
                  <li>
                    ✦ Developed an AI-powered exam monitoring protection system,
                    ensuring enhanced security and integrity during examination.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-[#344054] text-xl leading-[31px] tracking-[-0.6px]">
                <span>
                  ...
                  bridging capabilities across five different blockchains. In my
                  role as a Brand Designer, I contributed to the following:
                  <br />
                  <br />
                </span>
            ...
            <div>
              ...
              <div className="flex justify-between items-center mb-[28px]">
                <div>
                  <h1 className="text-[40px] tracking-[-1.2px] font-rocGroteskMid text-[#667085]">
                    Graphic Designer,{" "}
                    <strong className="text-[#101828]">Craze Creations</strong>
                  </h1>
                  <span className="text-[#344054] text-2xl font-normal tracking-[-0.72px] leading-[31px] font-rocGroteskReg opacity-[0.6]">
              ...
              <div className="text-[#344054] text-xl leading-[31px] tracking-[-0.6px]">
                ...
                <ul>
                  ...
                  <li>
                    ✦ Designed print and web banners to support both online and
